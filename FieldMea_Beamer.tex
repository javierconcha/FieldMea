...
\begin{itemize}\itemsep.3cm
	\item Validation: comparison to see how close a model to the field measurements is (accuracy)
	\item Calibration or Correction: adjust model to be more precise (data fitting)
\end{itemize}
\end{frame}
% --- slide ------------------------------------------------
