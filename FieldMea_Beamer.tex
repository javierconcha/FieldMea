...
%%%%%%%%%%%%%%%%%%% SECTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section[Pre/Post]{Preparation/Post Collect}
\subsection*{}
% --- slide ------------------------------------------------
...
\begin{frame}{Preparation}
	...
	\begin{itemize}
		...
		\item Check data in field 
		\item Clothing
	\end{itemize}
\end{frame}

% --- slide ------------------------------------------------
\begin{frame}{Post Collect}
	\begin{itemize}
		\item Download data
		\item Put meta data into excel
		\item Charge instruments
		\item Return Instruments
		\item Make sure data makes sense
	\end{itemize}
\end{frame}
