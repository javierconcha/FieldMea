...
\end{frame}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Radiometric Quantities} 
...
\end{frame}
% --- slide ------------------------------------------------
\begin{frame}{Radiometric Quantities}
...
\end{frame}
% --- slide ------------------------------------------------
\subsection[AOPs]{Apparent Optical Properties}
\begin{frame}{Apparent Optical Properties}
